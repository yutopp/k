...
public class TstBackendOnKORE extends BaseTest {
    ...
    public void kore_csemantics() throws IOException, URISyntaxException {
        ...
        Tuple2<Module, BiFunction<String, Source, K>> rwModuleAndProgramParser = new Kompile(FileUtil.testFileUtil()).run(new File(filename),
                "C11-TRANSLATION", "C11-TRANSLATION", "K");
        System.out.println(rwModuleAndProgramParser._1());;
        K program = rwModuleAndProgramParser._2().apply("t(.Set, int) ==Type t(.Set, int)", Source.apply("generated by " + getClass().getSimpleName()));
