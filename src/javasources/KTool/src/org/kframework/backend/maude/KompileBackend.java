...
public class KompileBackend extends BasicBackend {
    ...
    public KompileBackend(Stopwatch sw, Context context) {
        ...
        context.initializeHookedProperties(propPath + "MaudeHooksMap.properties");
        try {
    ...
    public Definition firstStep(Definition javaDef) {
        ...
        MaudeBuiltinsFilter builtinsFilter = new MaudeBuiltinsFilter(specialMaudeHooks, context);
