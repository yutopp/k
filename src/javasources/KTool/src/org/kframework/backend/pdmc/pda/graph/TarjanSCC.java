...
public class TarjanSCC<Data, Label> {
    ...
    /**
     * Retrieves the subgraph of this graph generated by the given vertices and all edges connecting them.
     * @param vertices represent the vertices for which the subgraph is requested
     * @return  the subgraph of this graph generated by {@code vertices}
     */
